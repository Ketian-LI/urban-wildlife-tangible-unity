...
- Automatically generated building access uses the same warm-white kerb, pale-grey surface, centre dashes and width as the baked original streets. Narrow equal-width white pedestrian strips touch both sides of the grey carriageway, while agents still follow one side as a separate route, so the composite road remains visually centred without reading as a broad white slab.
